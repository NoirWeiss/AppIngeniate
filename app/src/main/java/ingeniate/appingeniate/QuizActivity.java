...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent fragment_exam = getIntent();
        int option = fragment_exam.getIntExtra("option", 0);
        ...
        if (option == 0){
            all_questions = getResources().getStringArray(R.array.pm_exam);
        } else if (option == 1){
        all_questions = getResources().getStringArray(R.array.pa_exam);
        } else if (option == 2){
        all_questions = getResources().getStringArray(R.array.el_exam);
        } else {
        all_questions = getResources().getStringArray(R.array.cl_exam);
        }
